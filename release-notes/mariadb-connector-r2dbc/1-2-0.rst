...
<%PROD_VER_DATE%> This release is of GA (generally available) maturity. It is compatible with MariaDB Connector/R2DBC 1.1 and will therefore also be the maintenance path for version 1.1.  This release is compatible with «ext-uri»«https://r2dbc.io/spec/1.0.0.RELEASE/spec/html/»«R2DBC 1.0.0» specification.
